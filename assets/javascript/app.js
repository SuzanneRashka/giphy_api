...
function displayGiphy() {
    ...
    var queryUrl = "https://api.giphy.com/v1/gifs/search?q=+" + animal + "&limit=1&api_key=BX0itqePi01jzKkvmct3rqC41VPzzLEk";
    // imgTag.attr("data-animate", imgAnimate)
    $.ajax({
        url: queryUrl,
        method: "GET"
        ...
        response.data.forEach(function (gif) {
            ...
            var pTag = $("<p>").addClass("center").text('Rating : ' + gif.rating);
